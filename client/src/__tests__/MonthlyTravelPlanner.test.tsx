    ...
    mockLocations = [
      {
        ...
        description: { en: 'A large park', zh: '大公園' },
        category: 'park',
        coordinates: { lat: 40.7829, lng: -73.9654 },
        facilities: ['stroller_accessible'],
        averageRating: 4.8,
        address: { en: '123 Park Ave', zh: '公園大街123號' },
      } as unknown as Location,
      {
        id: '2',
        name: { en: 'Children Museum', zh: '兒童博物館' },
        description: { en: 'A museum for kids', zh: '兒童博物館' },
        category: 'attraction',
        coordinates: { lat: 40.7614, lng: -73.7776 },
        facilities: ['stroller_accessible'],
        averageRating: 4.6,
        address: { en: '456 Museum Rd', zh: '博物館路456號' },
      } as unknown as Location,
      {
        id: '3',
        ...
        averageRating: 4.3,
        address: { en: '789 Food St', zh: '美食街789號' },
      } as unknown as Location,
    ];
  });
