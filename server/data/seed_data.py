...
mock_locations: List[Dict[str, Any]] = [
    ...
    # --- Additional Taipei Attractions ---
    {
        "id": "tp07",
        "name": {"zh": "台北市立動物園", "en": "Taipei Zoo"},
        "description": {
            "zh": "台灣最大的動物園，設有貓熊館、昆蟲館及兒童動物區，是全家出遊的熱門景點。",
            "en": "Taiwan's largest zoo featuring giant pandas, an insect museum, and a children's animal area — perfect for family outings.",
        },
        "category": "attraction",
        "coordinates": {"lat": 24.9998, "lng": 121.5810},
        "address": {"zh": "台北市文山區新光路二段30號", "en": "No. 30, Sec. 2, Xinguang Rd., Wenshan Dist., Taipei"},
        "facilities": ["stroller_accessible", "public_toilet", "nursing_room", "parking", "high_chair", "drinking_water", "wheelchair_accessible"],
        "averageRating": 4.7,
        "phoneNumber": "02-2938-2300",
        "pricing": {"isFree": False, "priceRange": "60-100 NTD/person"},
        "operatingHours": {"monday": "休館", "tuesday": "09:00-17:00", "wednesday": "09:00-17:00", "thursday": "09:00-17:00", "friday": "09:00-17:00", "saturday": "09:00-17:00", "sunday": "09:00-17:00"},
        "publicTransit": {"nearestMRT": {"line": "文湖線", "station": "動物園站", "distance": 100}, "busLines": ["236", "251"]},
        "parking": {"available": True, "cost": "每小時30元", "hasValidation": False},
        "toilet": {"available": True, "childrenFriendly": True, "hasChangingTable": True},
        "hasWiFi": True,
        "weatherCoverage": {"isIndoor": False, "hasRoof": False, "hasShade": True, "weatherProtection": "部分展館室內，戶外有遮蔭"},
        "crowding": {"quietHours": "平日早上9-11點", "peakHours": "週末全天、寒暑假", "averageCrowding": "heavy"},
        "nursingAmenities": {"hasDedicatedArea": True, "hasChangingTable": True, "hasPowerOutlet": True, "hasRefrigerator": False, "hasWarmWater": True},
        "isVerified": True,
        "baselineCrowdedness": 70,
    },
    {
        "id": "tp08",
        "name": {"zh": "士林官邸兒童新樂園", "en": "Shilin Children's New Park"},
        "description": {
            "zh": "士林兒童新樂園擁有多項主題遊樂設施，包括雲霄飛車、摩天輪及旋轉木馬，適合3歲以上兒童。",
            "en": "Shilin Children's New Park features roller coasters, Ferris wheels, and carousels, ideal for children aged 3 and up.",
        },
        "category": "attraction",
        "coordinates": {"lat": 25.0921, "lng": 121.5145},
        "address": {"zh": "台北市士林區承德路五段55號", "en": "No. 55, Sec. 5, Chengde Rd., Shilin Dist., Taipei"},
        "facilities": ["stroller_accessible", "public_toilet", "nursing_room", "parking", "wheelchair_accessible"],
        "averageRating": 4.4,
        "phoneNumber": "02-2833-3823",
        "pricing": {"isFree": False, "priceRange": "100 NTD 入場+遊樂設施另計"},
        "operatingHours": {"monday": "休館", "tuesday": "10:00-20:00", "wednesday": "10:00-20:00", "thursday": "10:00-20:00", "friday": "10:00-21:00", "saturday": "10:00-21:00", "sunday": "10:00-20:00"},
        "publicTransit": {"nearestMRT": {"line": "淡水信義線", "station": "劍潭站", "distance": 500}, "busLines": ["41", "616", "小18"]},
        "parking": {"available": True, "cost": "每小時40元", "hasValidation": False},
        "toilet": {"available": True, "childrenFriendly": True, "hasChangingTable": True},
        "hasWiFi": True,
        "weatherCoverage": {"isIndoor": False, "hasRoof": False, "hasShade": True, "weatherProtection": "主要戶外，部分設施有遮棚"},
        "crowding": {"quietHours": "平日下午", "peakHours": "週末及寒暑假", "averageCrowding": "heavy"},
        "nursingAmenities": {"hasDedicatedArea": True, "hasChangingTable": True, "hasPowerOutlet": False, "hasRefrigerator": False, "hasWarmWater": False},
        "isVerified": True,
        "baselineCrowdedness": 65,
    },
    # --- Additional Parks ---
    {
        "id": "tp09",
        "name": {"zh": "青年公園", "en": "Youth Park"},
        "description": {
            "zh": "台北市萬華區的大型都市公園，設有兒童遊樂場、溜冰場、游泳池（夏季）及大片草地。",
            "en": "A large urban park in Wanhua District with playgrounds, a skating rink, summer swimming pool, and open lawns.",
        },
        "category": "park",
        "coordinates": {"lat": 25.0174, "lng": 121.5021},
        "address": {"zh": "台北市萬華區水源路199號", "en": "No. 199, Shuiyuan Rd., Wanhua Dist., Taipei"},
        "facilities": ["stroller_accessible", "public_toilet", "parking", "drinking_water", "playground_equipment", "outdoor_seating"],
        "averageRating": 4.3,
        "phoneNumber": "02-2302-9728",
        "pricing": {"isFree": True},
        "operatingHours": {"monday": "05:00-22:00", "tuesday": "05:00-22:00", "wednesday": "05:00-22:00", "thursday": "05:00-22:00", "friday": "05:00-22:00", "saturday": "05:00-22:00", "sunday": "05:00-22:00"},
        "publicTransit": {"nearestMRT": {"line": "松山新店線", "station": "古亭站", "distance": 800}, "busLines": ["204", "220", "295"]},
        "parking": {"available": True, "cost": "免費", "hasValidation": False},
        "toilet": {"available": True, "childrenFriendly": True, "hasChangingTable": False},
        "hasWiFi": False,
        "weatherCoverage": {"isIndoor": False, "hasRoof": False, "hasShade": True, "weatherProtection": "樹蔭覆蓋"},
        "crowding": {"quietHours": "平日早晨", "peakHours": "週末上午", "averageCrowding": "moderate"},
        "nursingAmenities": {"hasDedicatedArea": False, "hasChangingTable": False, "hasPowerOutlet": False, "hasRefrigerator": False, "hasWarmWater": False},
        "isVerified": True,
        "baselineCrowdedness": 45,
    },
    # --- Medical Facilities ---
    {
        "id": "med3",
        "name": {"zh": "馬偕紀念醫院兒科", "en": "Mackay Memorial Hospital Pediatrics"},
        "description": {
            "zh": "馬偕醫院為台灣頂尖醫療機構，兒科設備完善，提供新生兒及兒童全科診療服務。",
            "en": "Mackay Memorial Hospital is a top medical institution with comprehensive pediatric services for newborns and children.",
        },
        "category": "medical",
        "coordinates": {"lat": 25.0545, "lng": 121.5234},
        "address": {"zh": "台北市中山區中山北路二段92號", "en": "No. 92, Sec. 2, Zhongshan N. Rd., Zhongshan Dist., Taipei"},
        "facilities": ["stroller_accessible", "public_toilet", "nursing_room", "wheelchair_accessible", "elevator", "parking"],
        "averageRating": 4.5,
        "phoneNumber": "02-2543-3535",
        "pricing": {"isFree": False, "priceRange": "掛號費150元起"},
        "operatingHours": {"monday": "08:00-17:00", "tuesday": "08:00-17:00", "wednesday": "08:00-17:00", "thursday": "08:00-17:00", "friday": "08:00-17:00", "saturday": "08:00-12:00", "sunday": "急診24小時"},
        "publicTransit": {"nearestMRT": {"line": "淡水信義線", "station": "中山站", "distance": 400}, "busLines": ["21", "42"]},
        "parking": {"available": True, "cost": "每小時50元", "hasValidation": True},
        "toilet": {"available": True, "childrenFriendly": True, "hasChangingTable": True},
        "hasWiFi": True,
        "weatherCoverage": {"isIndoor": True, "hasRoof": True, "hasShade": True, "weatherProtection": "完全室內"},
        "crowding": {"quietHours": "平日下午14-16點", "peakHours": "週一上午、連假後", "averageCrowding": "heavy"},
        "nursingAmenities": {"hasDedicatedArea": True, "hasChangingTable": True, "hasPowerOutlet": True, "hasRefrigerator": True, "hasWarmWater": True},
        "isVerified": True,
        "baselineCrowdedness": 60,
    },
    # --- Nursing Rooms ---
    {
        "id": "nr05",
        "name": {"zh": "台北101購物中心哺乳室", "en": "Taipei 101 Mall Nursing Room"},
        "description": {
            "zh": "台北101商場B2設有親子廁所及哺乳室，設備完善，環境舒適。",
            "en": "Taipei 101 Mall B2 features a family restroom and nursing room with complete facilities in a comfortable environment.",
        },
        "category": "nursing_room",
        "coordinates": {"lat": 25.0337, "lng": 121.5645},
        "address": {"zh": "台北市信義區市府路45號B2", "en": "B2, No. 45, Shifu Rd., Xinyi Dist., Taipei"},
        "facilities": ["stroller_accessible", "nursing_room", "public_toilet", "wheelchair_accessible", "elevator"],
        "averageRating": 4.6,
        "pricing": {"isFree": True},
        "operatingHours": {"monday": "11:00-21:30", "tuesday": "11:00-21:30", "wednesday": "11:00-21:30", "thursday": "11:00-21:30", "friday": "11:00-22:00", "saturday": "11:00-22:00", "sunday": "11:00-21:30"},
        "publicTransit": {"nearestMRT": {"line": "板南線", "station": "台北101/世貿站", "distance": 50}, "busLines": ["33", "38"]},
        "parking": {"available": True, "cost": "第1小時免費", "hasValidation": True},
        "toilet": {"available": True, "childrenFriendly": True, "hasChangingTable": True},
        "hasWiFi": True,
        "weatherCoverage": {"isIndoor": True, "hasRoof": True, "hasShade": True, "weatherProtection": "完全室內"},
        "crowding": {"quietHours": "平日上午", "peakHours": "週末下午及連假", "averageCrowding": "moderate"},
        "nursingAmenities": {"hasDedicatedArea": True, "hasChangingTable": True, "hasPowerOutlet": True, "hasRefrigerator": True, "hasWarmWater": True},
        "isVerified": True,
        "baselineCrowdedness": 40,
    },
    # --- More Restaurants ---
    {
        "id": "r4",
        "name": {"zh": "幸福台灣親子餐廳（內湖店）", "en": "Happy Taiwan Family Restaurant (Neihu)"},
        "description": {
            "zh": "以台灣風土為主題的親子餐廳，設有三層樓親子遊戲區，提供台式健康兒童餐點。",
            "en": "Taiwan-themed family restaurant with a 3-floor play area offering healthy Taiwanese kids' meals.",
        },
        "category": "restaurant",
        "coordinates": {"lat": 25.0660, "lng": 121.5790},
        "address": {"zh": "台北市內湖區瑞光路512號", "en": "No. 512, Ruiguang Rd., Neihu Dist., Taipei"},
        "facilities": ["stroller_accessible", "nursing_room", "high_chair", "kids_menu", "indoor_play", "public_toilet", "changing_table", "parking"],
        "averageRating": 4.5,
        "phoneNumber": "02-7726-8899",
        "pricing": {"isFree": False, "priceRange": "350-650 NTD/person"},
        "operatingHours": {"monday": "休息", "tuesday": "11:30-21:00", "wednesday": "11:30-21:00", "thursday": "11:30-21:00", "friday": "11:30-21:30", "saturday": "10:30-21:30", "sunday": "10:30-21:00"},
        "publicTransit": {"nearestMRT": {"line": "文湖線", "station": "西湖站", "distance": 700}, "busLines": ["247", "267"]},
        "parking": {"available": True, "cost": "免費停車", "hasValidation": False},
        "toilet": {"available": True, "childrenFriendly": True, "hasChangingTable": True},
        "hasWiFi": True,
        "weatherCoverage": {"isIndoor": True, "hasRoof": True, "hasShade": True, "weatherProtection": "完全室內"},
        "crowding": {"quietHours": "平日午餐後14-17點", "peakHours": "週末及暑假全天", "averageCrowding": "moderate"},
        "nursingAmenities": {"hasDedicatedArea": True, "hasChangingTable": True, "hasPowerOutlet": True, "hasRefrigerator": True, "hasWarmWater": True},
        "isVerified": True,
        "baselineCrowdedness": 55,
    },
    # --- Taichung additions ---
    {
        "id": "tc05",
        "name": {"zh": "台中兒童公園", "en": "Taichung Children's Park"},
        "description": {
            "zh": "台中市最具代表性的兒童遊樂場所，設有主題遊具、沙坑及噴水池，假日吸引大批家庭前往。",
            "en": "Taichung's iconic children's playground with themed play equipment, sandpits, and water fountains, popular with families on weekends.",
        },
        "category": "park",
        "coordinates": {"lat": 24.1361, "lng": 120.6864},
        "address": {"zh": "台中市西區公益路135號", "en": "No. 135, Gongyi Rd., West Dist., Taichung"},
        "facilities": ["stroller_accessible", "public_toilet", "parking", "drinking_water", "playground_equipment"],
        "averageRating": 4.4,
        "pricing": {"isFree": True},
        "operatingHours": {"monday": "06:00-21:00", "tuesday": "06:00-21:00", "wednesday": "06:00-21:00", "thursday": "06:00-21:00", "friday": "06:00-21:00", "saturday": "06:00-21:00", "sunday": "06:00-21:00"},
        "publicTransit": {"nearestMRT": None, "busLines": ["20", "23", "300"]},
        "parking": {"available": True, "cost": "免費", "hasValidation": False},
        "toilet": {"available": True, "childrenFriendly": True, "hasChangingTable": False},
        "hasWiFi": False,
        "weatherCoverage": {"isIndoor": False, "hasRoof": False, "hasShade": True, "weatherProtection": "樹蔭"},
        ...
        "nursingAmenities": {"hasDedicatedArea": False, "hasChangingTable": False, "hasPowerOutlet": False, "hasRefrigerator": False, "hasWarmWater": False},
        "isVerified": True,
        "baselineCrowdedness": 50,
    },
    # --- Kaohsiung additions ---
    {
        "id": "kh06",
        "name": {"zh": "高雄義大世界遊樂場", "en": "E-DA Theme Park Kaohsiung"},
        "description": {
            "zh": "南台灣最大的主題樂園，集希臘式建築風格，設有過山車、水上樂園及大型商場，是家庭出遊首選。",
            "en": "Southern Taiwan's largest theme park with Greek architecture, roller coasters, water park, and a shopping mall — a top family destination.",
        },
        "category": "attraction",
        "coordinates": {"lat": 22.7249, "lng": 120.3929},
        "address": {"zh": "高雄市大樹區學城路一段12號", "en": "No. 12, Sec. 1, Xuecheng Rd., Dashu Dist., Kaohsiung"},
        "facilities": ["stroller_accessible", "public_toilet", "nursing_room", "parking", "high_chair", "wheelchair_accessible"],
        "averageRating": 4.5,
        "phoneNumber": "07-657-3333",
        "pricing": {"isFree": False, "priceRange": "599-899 NTD/person"},
        "operatingHours": {"monday": "10:00-17:30", "tuesday": "10:00-17:30", "wednesday": "10:00-17:30", "thursday": "10:00-17:30", "friday": "10:00-21:00", "saturday": "10:00-21:00", "sunday": "10:00-21:00"},
        "publicTransit": {"nearestMRT": None, "busLines": ["義大世界接駁巴士"]},
        "parking": {"available": True, "cost": "免費", "hasValidation": False},
        "toilet": {"available": True, "childrenFriendly": True, "hasChangingTable": True},
        "hasWiFi": True,
        "weatherCoverage": {"isIndoor": False, "hasRoof": False, "hasShade": True, "weatherProtection": "部分室內，戶外設施晴天適合"},
        "crowding": {"quietHours": "平日上午", "peakHours": "週末全天、暑假、連假", "averageCrowding": "heavy"},
        "nursingAmenities": {"hasDedicatedArea": True, "hasChangingTable": True, "hasPowerOutlet": True, "hasRefrigerator": False, "hasWarmWater": False},
        "isVerified": True,
        "baselineCrowdedness": 75,
    },
]
